...
public class GetDocuments {
	...
	*/
	public static ArrayList<String> queryBing(String query) throws UnsupportedEncodingException {
        ...
        */
        ...
        String mostRelevantLink = ars.getAsrs().get(0).getDisplayUrl();
        System.out.println(mostRelevantLink);
        
        AlchemyLanguage service = new AlchemyLanguage();
		service.setApiKey(alchemyKey);
		Map<String, Object> params = new HashMap<String, Object>();
		
		params.put(AlchemyLanguage.URL, mostRelevantLink);
		DocumentText text = service.getText(params).execute();
		//System.out.println(text.getText());
		
		Map<String, Object> paramsTitle = new HashMap<String, Object>();
        DocumentTitle title = service.getTitle(paramsTitle).execute();
        
        ArrayList<String> returns = new ArrayList<String>();
        returns.add(mostRelevantLink);
        returns.add(title.getTitle());
        returns.add(text.getText());
        for (AzureSearchRelatedSearchResult anr : ars2) {
        	returns.add(anr.getBingUrl());
        }
